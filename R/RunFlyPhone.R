...
#' @param multi Whether or not to use parallelization, if applicable on your machine. Defaults to FALSE.
#'
#' @return NULL
#'
#' @export
RunFlyPhone <- function(counts_fn = NULL, metadata_fn = NULL, DEG = NULL, pct_filter = 0.1, knowledgebase_version, perm_times = 1000, delimitor = "\t", seuratObject = NULL, control_name = NULL, mutant_name = NULL, deletePE = TRUE, base_output_dir = "", multi = FALSE) {
  # Preprocessing --------------------------------------------------------------
  ...
  results <- CalculateInteractions(counts_fn, metadata_fn, annotationObj, pathwayObj, perm_times, knowledgebase_version, delimitor, seuratObject, base_output_dir, multi)
